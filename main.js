...
$(document).ready(function () {
  ...
  var getZomatoData = function (cuisineType, sortType, orderType) {
    console.log("getZomatoData fired");
    ...
    function renderData() {
      ...
      // console.log(url);
       ...
       $.ajax({
        ...
        $(".card-container").empty();
         ...
         for (var i = 0; i < 20; i++) {
           ...
           var firstRow = $("<section>").attr("class", "col s5 m3 l3").css("margin-bottom", "5px");
           ...
           var listText = $("<section>").attr("class", "container col s7 m3 l3").css("margin-bottom", "5px");
       ...
       }); //end of .then funtion for ZomatoData//
    }
  };//end of get ZomatoData function//
